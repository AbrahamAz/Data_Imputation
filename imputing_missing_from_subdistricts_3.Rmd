...
COMHOTDECK_COM_NULL_NULL <- sapply(1:200, function(i) {cal_comm_hotdeck_com(order = NULL,
                                                                            domain = NULL)}) %>% 
  unlist() %>% 
  mean()
...
COMHOTDECK_COM_NULL_DIS.ARRIVAL <- sapply(1:200, function(i) {cal_comm_hotdeck_com(order = NULL, 
                                            domain = "T_District_En")}) %>%
  unlist() %>%
  mean()
...
COMHOTDECK_COM_HH.ARRIVAL_DIS.ARRIVAL <- sapply(1:200, function(i) {cal_comm_hotdeck_com(order = "New.Arrivals..HH.", 
                                            domain = "T_District_En")}) %>%
  unlist() %>%
  mean()
```
...
COMkNN_COM_100_LAT.LON_SAMPLE_TRUE <- sapply(1:200, function(i) {cal_comm_knn_com(100, dist_var = c("lat", "long"), catFun = sampleCat, addRandom = TRUE)}) %>%
  unlist() %>%
  mean()
```
...
plot1com <- data.frame(Approach=c("COMHOTDECK_COM_NULL_NULL","COMHOTDECK_COM_NULL_DIS.ARRIVAL",
...
write_xlsx(plot1com, "output/plot1com.xlsx")
```
...
COMkNN_HH_100_LAT.LON_SAMPLE_TRUE <- sapply(1:100, function(i) {cal_hh_knn_com(100, dist_var = c("lat", "long"), catFun = sampleCat, addRandom = TRUE)}) %>%
  unlist() %>%
  mean()
...
COMkNN_HH_50_LAT.LON_SAMPLE_TRUE <- sapply(1:100, function(i) {cal_hh_knn_com(50, dist_var = c("lat", "long"), catFun = sampleCat, addRandom = TRUE)}) %>%
  unlist() %>%
  mean()
...
COMkNN_HH_200_LAT.LON_SAMPLE_TRUE <- sapply(1:100, function(i) {cal_hh_knn_com(200, dist_var = c("lat", "long"), catFun = sampleCat, addRandom = TRUE)}) %>%
  unlist() %>%
  mean()
...
plot2com <- data.frame(Approach=c("COMkNN_HH_50_LAT.LON_SAMPLE_TRUE","COMkNN_HH_100_LAT.LON_SAMPLE_TRUE",
...
write_xlsx(plot2com, "output/plot2com.xlsx")
```
...
COMkNN_HH_200_LAT.LON.HH_SAMPLE_TRUE <- sapply(1:200, function(i) {
  cal_hh_knn_com(200, dist_var = c("lat", "long", "New.Arrivals..HH."), catFun = sampleCat, addRandom = TRUE)}) %>%
  unlist() %>%
  mean()
...
COMkNN_HH_200_LAT.LON_MAX_TRUE <- sapply(1:200, function(i) {
  cal_hh_knn_com(200, dist_var = c("lat", "long"), catFun = maxCat, addRandom = TRUE)}) %>%
  unlist() %>%
  mean()
...
COMkNN_HH_200_LAT.LON_SAMPLE_FALSE <- sapply(1:200, function(i) {
  cal_hh_knn_com(200, dist_var = c("lat", "long"), catFun = sampleCat, addRandom = FALSE)}) %>%
  unlist() %>%
  mean()
...
plot3com <- data.frame(Approach=c("COMkNN_HH_200_LAT.LON.HH_SAMPLE_TRUE","COMkNN_HH_200_LAT.LON_MAX_TRUE",
                                  "COMkNN_HH_200_LAT.LON_SAMPLE_FALSE"),
                       Margin_Error = c(COMkNN_HH_200_LAT.LON.HH_SAMPLE_TRUE,COMkNN_HH_200_LAT.LON_MAX_TRUE,
                                        COMkNN_HH_200_LAT.LON_SAMPLE_FALSE)) %>% 
  mutate(Margin_Error = round(Margin_Error, 4))
...
COMHOTDECK_HH_NULL_NULL <- sapply(1:200, function(i) {cal_hh_hotdeck_com(order = NULL, 
                                            domain = NULL)}) %>%
  unlist() %>%
  mean()
...
COMHOTDECK_HH_NULL_DIS.ARRIVAL <- sapply(1:200, function(i) {cal_hh_hotdeck_com(order = NULL, 
                                            domain = "T_District_En")}) %>%
  unlist() %>%
  mean()
...
COMHOTDECK_HH_HH.ARRIVAL_DIS.ARRIVAL <- sapply(1:200, function(i) {cal_hh_hotdeck_com(order = "New.Arrivals..HH.", 
                                            domain = "T_District_En")}) %>%
  unlist() %>%
  mean()
...
plot4com <- data.frame(Approach=c("COMHOTDECK_HH_NULL_NULL","COMHOTDECK_HH_NULL_DIS.ARRIVAL","COMHOTDECK_HH_HH.ARRIVAL_DIS.ARRIVAL"), 
...
write_xlsx(plot4com, "output/plot4com.xlsx")
```
...
SUBkNN_COM_100_LAT.LON_SAMPLE_TRUE <- sapply(1:200, function(i) {cal_comm_knn_sub(100, dist_var = c("lat", "long"),
                                                                                  catFun = sampleCat, addRandom = TRUE,
                                                                                  forced = TRUE)}) %>%
  unlist() %>%
  mean()

COMkNN_COM_100_LAT.LON_SAMPLE_TRUE <- sapply(1:200, function(i) {cal_comm_knn_com(100, dist_var = c("lat", "long"),
                                                                                  catFun = sampleCat, addRandom = TRUE,
                                                                                  forced = TRUE)}) %>%
  unlist() %>%
  mean()
...
SUBkNN_HH_100_LAT.LON_SAMPLE_TRUE <- sapply(1:100, function(i) {cal_hh_knn_sub(100, dist_var = c("lat", "long"),
                                                                               catFun = sampleCat, addRandom = TRUE,
                                                                               forced = TRUE)}) %>%
  unlist() %>%
  mean()

COMkNN_HH_100_LAT.LON_SAMPLE_TRUE <- sapply(1:100, function(i) {cal_hh_knn_com(100, dist_var = c("lat", "long"),
                                                                               catFun = sampleCat, addRandom = TRUE,
                                                                               forced = TRUE)}) %>%
  unlist() %>%
  mean()
...
SUBkNN_HH_50_LAT.LON_SAMPLE_TRUE <- sapply(1:100, function(i) {cal_hh_knn_sub(50, dist_var = c("lat", "long"),
                                                                              catFun = sampleCat, addRandom = TRUE,
                                                                              forced = TRUE)}) %>%
  unlist() %>%
  mean()

COMkNN_HH_50_LAT.LON_SAMPLE_TRUE <- sapply(1:100, function(i) {cal_hh_knn_com(50, dist_var = c("lat", "long"),
                                                                              catFun = sampleCat, addRandom = TRUE,
                                                                              forced = TRUE)}) %>%
  unlist() %>%
  mean()
...
SUBkNN_HH_200_LAT.LON_SAMPLE_TRUE <- sapply(1:100, function(i) {cal_hh_knn_sub(200, dist_var = c("lat", "long"),
                                                                               catFun = sampleCat, addRandom = TRUE,
                                                                               forced = TRUE)}) %>%
  unlist() %>%
  mean()

COMkNN_HH_200_LAT.LON_SAMPLE_TRUE <- sapply(1:100, function(i) {cal_hh_knn_com(200, dist_var = c("lat", "long"),
                                                                               catFun = sampleCat, addRandom = TRUE,
                                                                               forced = TRUE)}) %>%
  unlist() %>%
  mean()
...
COMkNN_HH_200_LAT.LON_MAX_TRUE <- sapply(1:200, function(i) {
  cal_hh_knn_com(200, dist_var = c("lat", "long"), catFun = maxCat, addRandom = TRUE,forced = TRUE)}) %>%
  unlist() %>%
  mean()
...
COMkNN_HH_200_LAT.LON_SAMPLE_FALSE <- sapply(1:200, function(i) {
  cal_hh_knn_com(200, dist_var = c("lat", "long"), catFun = sampleCat, addRandom = FALSE, forced = TRUE)}) %>%
  unlist() %>%
  mean()
...
plot1comforced <- data.frame(Approach=c("COMHOTDECK_COM_NULL_NULL","COMHOTDECK_COM_NULL_DIS.ARRIVAL",
                                  "COMHOTDECK_COM_HH.ARRIVAL_DIS.ARRIVAL","COMkNN_COM_100_LAT.LON_SAMPLE_TRUE"),
                       Margin_Error = c(COMHOTDECK_COM_NULL_NULL,COMHOTDECK_COM_NULL_DIS.ARRIVAL,
                                        COMHOTDECK_COM_HH.ARRIVAL_DIS.ARRIVAL,COMkNN_COM_100_LAT.LON_SAMPLE_TRUE)) %>% 
  mutate(Margin_Error = round(Margin_Error, 4))
...
plot2comforced <- data.frame(Approach=c("COMkNN_HH_50_LAT.LON_SAMPLE_TRUE","COMkNN_HH_100_LAT.LON_SAMPLE_TRUE",
                                  "COMkNN_HH_200_LAT.LON_SAMPLE_TRUE"),
                       Margin_Error = c(COMkNN_HH_50_LAT.LON_SAMPLE_TRUE,COMkNN_HH_100_LAT.LON_SAMPLE_TRUE,COMkNN_HH_200_LAT.LON_SAMPLE_TRUE)) %>% 
  mutate(Margin_Error = round(Margin_Error, 4))
...
plot3comforced <- data.frame(Approach=c("COMkNN_HH_200_LAT.LON.HH_SAMPLE_TRUE","COMkNN_HH_200_LAT.LON_MAX_TRUE",
                                  "COMkNN_HH_200_LAT.LON_SAMPLE_FALSE"),
                       Margin_Error = c(COMkNN_HH_200_LAT.LON.HH_SAMPLE_TRUE,COMkNN_HH_200_LAT.LON_MAX_TRUE,
                                        COMkNN_HH_200_LAT.LON_SAMPLE_FALSE)) %>% 
  mutate(Margin_Error = round(Margin_Error, 4))
...
plot4comforced <- data.frame(Approach=c("COMHOTDECK_HH_NULL_NULL","COMHOTDECK_HH_NULL_DIS.ARRIVAL","COMHOTDECK_HH_HH.ARRIVAL_DIS.ARRIVAL"), 
                       Margin_Error = c(COMHOTDECK_HH_NULL_NULL,COMHOTDECK_HH_NULL_DIS.ARRIVAL,COMHOTDECK_HH_HH.ARRIVAL_DIS.ARRIVAL)) %>% 
  mutate(Margin_Error = round(Margin_Error, 4))

write_xlsx(plot1subforced, "output/plot1subforced.xlsx")
write_xlsx(plot1comforced, "output/plot1comforced.xlsx")
write_xlsx(plot2subforced, "output/plot2subforced.xlsx")
write_xlsx(plot2comforced, "output/plot2comforced.xlsx")
...
write_xlsx(plot4comforced, "output/plot4comforced.xlsx")
```
